...
def render_page():
    try:
        from SPINN_model.H3_separate.VGM_PTF import VGM_PTF
        from SPINN_model.H3_separate.M3_PTF  import M3_PTF
        from SPINN_model.H3_separate.B_FXW_PTF import B_FXW_PTF
    ...
    st.text('H3-separate: When training PTFs, first train the parameters of SWRC, and then train the parameters of HCC.')
